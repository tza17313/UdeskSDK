...
- (CGFloat)tableView:(UITableView *)tableView heightForHeaderInSection:(NSInteger)section {
    ...
    if (self.menuPage) {
        ...
        CGSize pathSize = [UdeskGeneral.store textSize:self.pathString fontOfSize:[UIFont systemFontOfSize:17] ToSize:CGSizeMake(tableView.ud_width, CGFLOAT_MAX)];
